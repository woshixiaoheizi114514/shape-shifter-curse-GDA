...
import net.onixary.shapeShifterCurseFabric.recipes.alter.BuiltinAlterRecipe;
...
public class RecipeSerializerRegister {
    ...
    public static RecipeSerializer<BuiltinAlterRecipe> BUILTIN_ALTER_RECIPE = register(ShapeShifterCurseFabric.identifier("builtin_alter"), new BuiltinAlterRecipe.Serializer());
