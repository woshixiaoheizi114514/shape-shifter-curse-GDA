...
public final class RegCustomBlock {
    ...
    public static final Block ALTER_BLOCK = register("alter", new AlterBlock(AbstractBlock.Settings.create().mapColor(MapColor.WHITE_GRAY).instrument(Instrument.BELL).strength(1.0F).sounds(BlockSoundGroup.STONE).nonOpaque()));
